...
<body>
    <header>
        ...
        <div class="nav_bar_Community">
          ...
          <ul class="nav_options_Community">
            <li class="option"><a href="feed.php"><img class="icons" src="icons/casa.png" alt="início"></a></li>
            <li class="option"><a href="createPost.php"><img class="icons" src="icons/botao-adicionar.png" alt="Criar Post"></a></li>
          ...
          <div class="user-toggle" onclick="toggleUser()">
            ...
            <div class="btnUser">
              <a href="profile.php"><img class="user-pic" src="icons/user.png" alt="foto do usuário"></a>
            </div>
          </div>
  ...
  <nav class="nav" id="nav">
    <ul class="navList">
      ...
      <li class="navItem"><img class="icons"src="icons/casa.png"><a class="navLink" href="feed.php">Início</a></li>
      <li class="navItem"><img class="icons"src="icons/botao-adicionar.png"><a class="navLink" href="createPost.php">Criar Post</a></li>
