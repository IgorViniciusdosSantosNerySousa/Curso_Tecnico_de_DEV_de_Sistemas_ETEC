...
<body>
  <?php
    ...
    function assunto_validar($assunto) {
        $assuntos = [
            "Computadores",
            "Conversas",
            "Dúvida",
    ...
    $assunto = (assunto_validar($_GET['a'])) ? $_GET['a'] : "";
  ?>
    ...
    <div class="options">
      ...
      <div class="view">
        ...
        <ul class="topicList">
          ...
          <a href="search.php?p=<?php if (trim($_GET['p'], " ") !== "") { echo $_GET['p']; } ?>&a=Computadores" style="text-decoration: none;">
            <li class="subjectOption">Computadores</li>
          </a>
          <a href="search.php?p=<?php if (trim($_GET['p'], " ") !== "") { echo $_GET['p']; } ?>&a=Conversas" style="text-decoration: none;">
            <li class="subjectOption">Conversas</li>
          </a>
          <a href="search.php?p=<?php if (trim($_GET['p'], " ") !== "") { echo $_GET['p']; } ?>&a=Dúvida" style="text-decoration: none;">
              <li class="subjectOption">Dúvida</li>
          </a>
          <a href="search.php?p=<?php if (trim($_GET['p'], " ") !== "") { echo $_GET['p']; } ?>&a=Estudos" style="text-decoration: none;">
              <li class="subjectOption">Estudos</li>
          </a>
          <a href="search.php?p=<?php if (trim($_GET['p'], " ") !== "") { echo $_GET['p']; } ?>&a=Informação" style="text-decoration: none;">
              <li class="subjectOption">Informação</li>
          </a>
          <a href="search.php?p=<?php if (trim($_GET['p'], " ") !== "") { echo $_GET['p']; } ?>&a=Meme" style="text-decoration: none;">
              <li class="subjectOption">Memes</li>
          </a>
          <a href="search.php?p=<?php if (trim($_GET['p'], " ") !== "") { echo $_GET['p']; } ?>&a=Programação" style="text-decoration: none;">
              <li class="subjectOption">Programação</li>
          </a>
          <a href="search.php?p=<?php if (trim($_GET['p'], " ") !== "") { echo $_GET['p']; } ?>&a=Trabalho" style="text-decoration: none;">
  ...
  <script>
    ...
    function loadPosts() {
      ...
      fetch(`./api/search.php?userId=${userId}&limit=${limit}&offset=${offset}&p=<?php echo $_GET['p']; ?>&a=<?php echo $assunto; ?>`)
        .then(response => {
          if (!response.ok) {
